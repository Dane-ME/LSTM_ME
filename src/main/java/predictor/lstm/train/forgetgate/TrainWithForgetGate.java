...
import predictor.lstm.validator.forgetgate.ValidationSeasonalityModelWithForgetGate;
import predictor.lstm.validator.forgetgate.ValidationTrendModelWithForgetGate;

public class TrainWithForgetGate {
    ...
    public TrainWithForgetGate(//
        ...
        for (int epoch = hyperParameter.getEpochTrack(); epoch < hyperParameter.getEpoch(); epoch++) {
            ...
            for (int batch = hyperParameter.getBatchTrack(); batch < hyperParameter.getBatchSize(); batch++) {
                ...
                MakeModelWithForgetGate makeModels = new MakeModelWithForgetGate();
                ...
                CompletableFuture<Void> firstTaskFuture = CompletableFuture
                        ...
                        .thenAccept(untestedSeasonalityMoadels -> new ValidationSeasonalityModelWithForgetGate().validateSeasonality(
                ...
                CompletableFuture<Void> secondTaskFuture = CompletableFuture
                        ...
                        .thenAccept(untestedSeasonalityMoadels -> new ValidationTrendModelWithForgetGate().validateTrend(validateData,
