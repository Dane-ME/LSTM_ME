...
public class LstmTrainImproved implements Runnable {

    private final Logger log = LoggerFactory.getLogger(LstmTrainImproved.class);

    private final ChannelAddress channelAddress;
    private final long days;
    private final String filePath;

    public LstmTrainImproved(ChannelAddress channelAddress, long days, String filePath) {
    ...
    public void run() {
        ...
        TrainAndValidateBatchImproved trainer = new TrainAndValidateBatchImproved(
