...
import predictor.lstm.util.improved.LstmImproved.LstmBuilder;

public class EngineImproved {
    ...
    public void fit(int epochs, ArrayList<ArrayList<Double>> val, HyperParameters hyperParameters) {
        var rate = new AdaptiveLearningRateImproved();
    ...
    public EngineImproved(EngineBuilder builder) {
    ...
    public static class EngineBuilder {
        ...
        public EngineImproved build() {
            return new EngineImproved(this);
        }
    }
