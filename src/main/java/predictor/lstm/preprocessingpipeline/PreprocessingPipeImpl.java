...
public class PreprocessingPipeImpl implements PipelineInterface<Object, Object> {
    ...
    /**
     * Add Replace Zeros with NaNs stage.
     *
     * @return this
     */
    public PreprocessingPipeImpl replaceZerosWithNaNs() {
        return this.addStage(new ZeroToNanPipe());
    }
